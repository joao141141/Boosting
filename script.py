...
print(f'Ada ACC Score: {accuracy_score(y_test, y_pred_ada)}')
print(f'f1 Ada Score: {f1_score(y_test, y_pred_ada)}')
print(f'gradient Accuracy Score: {accuracy_score(y_test, y_pred_grad)}')
print(f'f1 Gradient Score: {f1_score(y_test, y_pred_grad)}')
